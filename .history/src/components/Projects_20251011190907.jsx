...
export const Projects = () => {
  return (
    <section id="projects" className="relative min-h-screen py-12 flex flex-col justify-center">
      ...
      <div className="mx-auto max-w-6xl rounded-lg p-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {PROJECTS.map((project) => (
          <div key={project.id} className="bg-white rounded-lg p-4 shadow-md aspect-1/3">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href={project.external_link} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Live</a>
            </div>
          </div>
        ))}
      </div>
