      ...
      <div className=" mx-auto max-w-6xl rounded-lg p-4 grid-cols-1 gap-6">
        {experiences.map((experience, index) => (
          <div className="z-0 relative gradient-border">
            <div className="w-full h-full relative container flex flex-cols md:flex-rows rounded-md p-6 bg-background after:h-[110%] after:rounded-md after:absolute after:top-0 after:left-0 after:-z-10 after:opacity-20 after:blur-lg">
              <div className="p-4">
