...
export const About = () => {
  return (
    <section id="about" className="relative min-h-screen py-12">
      ...
      <div className="bg-red-900 mx-auto mt-8 max-w-6xl rounded-lg p-6 grid-cols-1 gap-6">
        {experiences.map((experience, index) => (
          <div key={index} className="flex flex-row justify-between items-start p-4">
            <h2 className="flex items-center text-2xl font-semibold mb-2">
              <experience.icon className="w-6 h-6 left bg-blue-900" />
              {experience.name}
            </h2>
            <div>
