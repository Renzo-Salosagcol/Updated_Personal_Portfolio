...
const project_info = [
  {
    id: 1,
    title: "Guild Table",
    description: "Guild Table is an actively developed virtual tabletop (VTT) web app for playing Dungeons & Dragons online without screen sharing. " +
    "It provides character management (generation, sheets, stats, inventory), monster management (import & deploy to the VTT), a VTT with multi-map support, DM object visibility controls, annotations, and token-based representation. " +
    "Battle assistance includes automatic damage calculation from rolls & stats and turn tracking. Campaign tools include a wiki (private DM notes + public lore) and player invitations. Feature set and availability may change during development.",
