      ...
      <div className="z-0 relative gradient-border opacity-0 animate-fade-in">
        <div className="w-full h-full relative container flex justify-between gap-6 rounded-md p-6 bg-background">
          <div className="container flex flex-col gap-1">
            ...
            <h3 className="w-md md:w-lg lg:w-xl text-md">Problem solving and critical thinking are some of my favorite and most rewarding activities. Coding is a way for me to express my creativity and bring ideas to life while consistently approaching and adapting to new challenges.</h3>
          </div>
          <div>
            <img 
            src="../../headshot.jpeg" 
