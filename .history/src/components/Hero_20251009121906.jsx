  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center max-w-10/12 rounded-md container z-0">
      <div className="z-0 relative gradient-border opacity-0 animate-fade-in">
        <div className="w-full h-full relative container flex justify-between gap-6 rounded-full p-6 bg-background">
          <div className="">
            <h1 className="">Name</h1>
          </div>
          <div>
            <img src="../../public/headshot.jpeg" alt="Headshot Photo" />
          </div>
      </div>
      </div>
    </main>
