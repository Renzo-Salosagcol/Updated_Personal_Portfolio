    ...
    <section id="contact" className="relative min-h-screen py-12 flex flex-col justify-center">
      ...
      <div className=" mx-auto max-w-6xl rounded-lg gradient-card">
        <div className="gradient-card-inner flex flex-col items-center gap-6">
            ...
            <form className="space-y-6 w-full items-center">
              ...
              <button
                ...
                <div className="gradient-button-inner hover:gradient-text">
                  <h5 className="text-foreground p-2 py-1 hover:text-background">
              ...
              <button type="submit"
                ...
                onClick={handleSubmit}
              >
                <div className="gradient-button-inner inline-flex items-center gap-2 p-2">
                  <div className="hover:gradient-text transition-all duration-300 inline-flex items-center gap-2">
                    {isSubmitting ? "Sending..." : "Send Message"}
                    <Send size={16} />
                  </div>
                </div>
          ...
          <div className="w-full">
            <h2 className="flex flex-row items-center gap-2 w-full">
