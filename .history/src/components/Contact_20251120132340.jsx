            ...
            <ul className="flex md:flex-row sm:flex-col gap-6 text-lg items-left">
              {SOCIAL_MEDIA.map((platform) => (
                <li key={platform.name}>
                  <a href={platform.link} target="_blank" rel="noopener noreferrer" className="flex flex-row items-left gap-2 hover:gradient-text">
                    <platform.icon size={20} className="mt-1 hover:text-foreground"/> {platform.name}
                  </a>
                </li>
              ))}
            </ul>
