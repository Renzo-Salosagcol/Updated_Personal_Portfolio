          ...
          <div key={project.id} className="gradient-card max-w-8/10 h-full">
            <div className="gradient-card-inner">
              ...
              <div className="flex items-center justify-between">
                <a href={project.github_link} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"><GithubIcon /></a>
                <a href={project.external_link} target="_blank" rel="noopener noreferrer" className="text-secondary hover:underline"><ExternalLink /></a>
              </div>
            </div>
          </div>
        ))}
