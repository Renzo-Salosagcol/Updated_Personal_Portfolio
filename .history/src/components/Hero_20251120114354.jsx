      ...
      <div className="gradient-card opacity-0 animate-fade-in">
        <div className="gradient-card-inner flex flex-cols lg:flex-rows justify-between gap-6 rounded-md bg-background">
          <div className="container flex flex-col gap-1">
            ...
            >
              <button className="gradient-button cursor-pointer hover:text-foreground">
                <div className="gradient-button-inner hover:text-foreground">
                  <h5 className="gradient-text p-2 hover:text-foreground">Learn more...</h5>
                </div>
              </button>
            </a>
          </div>
