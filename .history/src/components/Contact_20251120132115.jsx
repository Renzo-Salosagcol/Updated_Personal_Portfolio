...
const SOCIAL_MEDIA = [
  { name: "Facebook", icon: Facebook, link: "https://www.facebook.com/your-profile" },
  { name: "Instagram", icon: Instagram, link: "https://www.instagram.com/your-profile" },
  { name: "Twitter", icon: Twitter, link: "https://www.twitter.com/your-profile" },
      ...
      <div className=" mx-auto max-w-6xl rounded-lg gradient-card">
        <div className="gradient-card-inner flex flex-col items-center gap-6">
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            <form className="space-y-6 w-full items-center">
          ...
          <div className="w-full items-center">
            <h2 className="flex flex-row items-center gap-4 w-full justify-center font-semibold">
              <div className="bg-foreground h-0.5 w-full"> </div>
              OR
              <div className="bg-foreground h-0.5 w-full"> </div>
            </h2>
          </div>
          <div className="flex flex-col items-center gap-6">
            ...
            <ul className="flex flex-row gap-6 text-lg items-left">
              {SOCIAL_MEDIA.map((platform) => (
                <li key={platform.name}>
                  <a href={platform.link} target="_blank" rel="noopener noreferrer" className="flex flex-rows items-left gap-4">
                    <platform.icon size={20} className="mt-5/> {platform.name}
                  </a>
                </li>
              ))}
            </ul>
