 ...
 const [isMenuOpen, setIsMenuOpen] = React.useState(true);
  ...
  return (
    <nav className="fixed top-0 left-0 w-full p-1 flex items-center justify-between glassmorphism z-40 text-sm md:text-md text-foreground">
      ...
      <div className={clsx("fixed md:hidden inset-0 p-2 flex flex-col items-center justify-center backdrop-blur-md transition-all duration-300 my-auto z-40 bg-background/70",
