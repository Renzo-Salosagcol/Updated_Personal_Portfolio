      ...
      <div className=" mx-auto max-w-6xl rounded-lg gradient-card">
        <div className="gradient-card-inner flex flex-col items-center gap-6">
          ...
          <div className="w-full items-center">
            <h2 className="flex flex-row items-center gap-2 w-full justify-center">
              <div className="bg-color-foreground h-1 w-full"></div>
              OR
              <div className="font-stretch-expanded w-full">-</div>
            </h2>
          </div>
