...
const categories = [
  {
    ...
    experiences: [{
      ...
      period: "2023 - 2025",
      description: "Mission-driven: CS fundamentals, systems, problem solving. " +
      "Adaptability to advancing tech; research exposure. " +
      "Technical growth: modern practices & workforce readiness. " +
      "Professional skills: clear communication, leadership. " +
      "Ethical citizenship: sound technical decisions. " +
      "Outcomes: analyze complex problems; design & evaluate. " +
      "Apply theory & SD fundamentals for robust solutions. " +
      "Team contributor & leader across varied contexts. " +
      "Graduated May 2025; prepared for production dev.",
    },
    {
  ...
  },
  {
    ...
    },
    {
      ...
      "Adapts schedule; evenings/weekends/holidays. " +
      "CPR within 30 days; attends mandatory training. " +
      "Lifts 40+ lbs; routine bending; system data entry. " +
      "Enjoys growth perks: free membership + guest. " +
      "Access to training, discounts, referral bonuses. " +
      "Benefits: health, vision, dental, EAP, 401k match.",
    },
    {
