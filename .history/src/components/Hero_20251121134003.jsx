  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center max-w-10/12 rounded-md container z-0">
      <div className="gradient-card opacity-0 animate-fade-in">
        <div className="gradient-card-inner flex flex-col lg:flex-row items-center gap-4 rounded-md bg-background">
          <div className="container flex flex-col gap-1 text-wrap">
          ...
          <div>
            ...
            src="../../headshot.jpeg" 
            alt="Headshot Photo"
            className="rounded-md w-64 h-64 object-center object-cover"
            />
          </div>
      </div>
      </div>
